...
# Dungeon Master's Guide: page 27
RollItem.create(item_type: :leader_types, range_min: 1, range_max: 1, content: { leader_type: 'Political', description: 'Political leaders are monarchs, nobles, and chiefs.' })
RollItem.create(item_type: :leader_types, range_min: 2, range_max: 2, content: { leader_type: 'Religious', description: 'Religious leaders include deities\' avatars, high priests, and messiahs, as well as those in charge of monasteries and leaders of influential religious sects.' })
RollItem.create(item_type: :leader_types, range_min: 3, range_max: 3, content: { leader_type: 'Military', description: 'Major military leaders control the armed forces of countries. They include military dictators, warlords, and the heads of a ruler\'s war council. Minor military leaders include the heads of local militias, gangs, and other martial organizations.' })
