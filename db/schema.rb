...
ActiveRecord::Schema.define(version: 2020_05_04_055745) do
  ...
  create_table "roll_items", force: :cascade do |t|
    ...
    t.index ["item_type", "range_min", "range_max"], name: "index_roll_items_on_item_type_and_range_min_and_range_max"
  end
